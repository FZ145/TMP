...
public class ListUtil {
    public static List<HistoryAndWeight<RenterHistory>> getAvailableRenterHistory(List<RenterHistory> tableList,Integer daysThreshold) {
    ...
    public static List<HistoryAndWeight<ComponentHistory>> getAvailableComponentHistory(List<ComponentHistory> tableList,Integer daysThreshold) {
